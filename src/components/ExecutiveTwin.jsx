                ...
                <div className="container">
                    <div className="row g-5 mb-5">
                        <div className="col-lg-5 wow zoomIn" data-wow-delay="0.3s" style={{ minHeight: '400px' }}>
                            <img className="img-fluid" src="img/Xc.jpg" alt="Executive Twin Rooms" />
                            <h6 className="display-6 mb-0">Executive-Twin-Rooms</h6>
                            <p>Large space, Jacuzzi, air condition, fan, refrigerator, hair dryer, LCD, internet connection, coffee maker in room, room telephone and shower/toilet, bath tub, bath.</p>
                        </div>
