            ...
            <div className="container-fluid bg-primary py-5 hero-header mb-5">
                <div className="row py-3">
                    <div className="col-12 text-center">
                        <h1 className="display-3 text-white animated zoomIn">Triple Rooms</h1>
                        <a href="#" className="h4 text-white">Home</a>
                        <i className="far fa-circle text-white px-2"></i>
                        <a href="#" className="h4 text-white">Triple Rooms</a>
                    </div>
                </div>
            </div>
            {/* Hero End */}
                ...
                <div className="container">
                    <div className="row g-5 mb-5">
                        <div className="col-lg-5 wow zoomIn" data-wow-delay="0.3s" style={{ minHeight: '400px' }}>
                            <img className="img-fluid" src="img/Xc.jpg" alt="Triple Rooms" />
                            <h6 className="display-6 mb-0">Triple Rooms</h6>
                            <p>Three beds, air condition, LCD, internet connection, coffee maker in room, balcony, fan, refrigerator, hair dryer, room telephone and shower/toilet, bath tub, bath/toilet.</p>
                        </div>
